...
LPTSTR WINAPI GetCommandLine(void) {
  return g_cmdline != NULL ? g_cmdline : "";
}
...
// TODO: implement me
/* CreateProcess definido no .h ou stub */
BOOL WINAPI CreateProcessStub(LPCTSTR lpApplicationName,
...
// Shim: uma regiao unica cobrindo o endereco
SIZE_T WINAPI VirtualQuery(
  ...
  mbi->BaseAddress = (PVOID)((uintptr_t)lpAddress & ~(uintptr_t)4095);
  mbi->AllocationBase = mbi->BaseAddress;
  mbi->AllocationProtect = PAGE_READWRITE;
  mbi->RegionSize = (SIZE_T)((uintptr_t)0x7ffffffff000ULL - (uintptr_t)mbi->BaseAddress);
