...
{0x00002328L, "MSG_NOYES_RESPONSE_DATA", "NY%0"}
...
, {0x00002331L, "MSG_DIR_BAD_COMMAND_OR_FILE", "'%1' is not recognized as an internal or external command,\noperable program or batch file."}
, {0x00002332L, "MSG_REN_INVALID_TIME", "The system cannot accept the time entered."}
, {0x00002334L, "MSG_COPYRIGHT", "(C) Copyright 1985-2003 Microsoft Corp."}
, {0x00002335L, "MSG_C", "^C"}
...
, {0x00002350L, "MSG_MS_DOS_VERSION", "Microsoft Windows [Version %1]%0"}
...
, {0x0000236dL, "MSG_DIRS_MOVED", "%1 dir(s) moved."}
...
, {0x00002379L, "MSG_FILES_TOTAL_FREE", "     %1 Dir(s)  %2 bytes free"}
...
, {0x00002383L, "MSG_HELP_EXIT", "Quits the CMD.EXE program (command interpreter) or the current batch\nscript.\n\nEXIT [/B] [exitCode]\n\n  /B          specifies to exit the current batch script instead of\n              CMD.EXE.  If executed from outside a batch script, it\n              will quit CMD.EXE\n\n  exitCode    specifies a numeric number.  if /B is specified, sets\n              ERRORLEVEL that number.  If quitting CMD.EXE, sets the process\n              exit code with that number."}
...
, {0x0000238cL, "MSG_HELP_VER", "Displays the Windows version.\n\nVER"}
...
, {0x00002727L, "MSG_ERROR_BATCH_RECURSION", "******  B A T C H   R E C U R S I O N  exceeds STACK limits ******\nRecursion Count=%1!d!, Stack Usage=%2!d! percent\n******       B A T C H   PROCESSING IS   A B O R T E D      ******"}
, {0x00002728L, "MSG_ERROR_PUSHD_DEPTH_EXCEEDED", "There are too many directories already in the PUSHD stack."}
, {0x00002729L, "MSG_DISABLED_BY_POLICY", "\nThe command prompt has been disabled by your administrator.\n"}
